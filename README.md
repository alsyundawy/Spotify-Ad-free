...
Current Spotify Release: [Spotify 1.0.98.78.gb45d2a6b](https://download.scdn.co/SpotifyFullSetup.exe), see [here](https://github.com/CHEF-KOCH/Spotify-Ad-free/releases/tag/2.2) for mod infos.
